...
/* .Call calls */
extern SEXP _xyz_absolute_covariates(SEXP, SEXP, SEXP);
extern SEXP _xyz_absolute_covariates_pairs(SEXP, SEXP, SEXP, SEXP);
...
extern SEXP _xyz_find_strongest_pairs(SEXP, SEXP, SEXP, SEXP, SEXP);
extern SEXP _xyz_gaussiglmnet(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
extern SEXP _xyz_interaction_search(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
extern SEXP _xyz_interaction_search_low_level(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
extern SEXP _xyz_iterate(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
extern SEXP _xyz_naive_interaction_search(SEXP, SEXP, SEXP, SEXP);
...
extern SEXP _xyz_update_intr_vars(SEXP, SEXP, SEXP);
extern SEXP _xyz_warm_start(SEXP, SEXP, SEXP, SEXP, SEXP);

static const R_CallMethodDef CallEntries[] = {
    {"_xyz_absolute_covariates",                       (DL_FUNC) &_xyz_absolute_covariates,                        3},
    {"_xyz_absolute_covariates_pairs",                 (DL_FUNC) &_xyz_absolute_covariates_pairs,                  4},
    ...
    {"_xyz_find_strongest_pairs",                      (DL_FUNC) &_xyz_find_strongest_pairs,                       5},
    {"_xyz_gaussiglmnet",                              (DL_FUNC) &_xyz_gaussiglmnet,                               9},
    {"_xyz_interaction_search",                        (DL_FUNC) &_xyz_interaction_search,                         7},
    {"_xyz_interaction_search_low_level",              (DL_FUNC) &_xyz_interaction_search_low_level,               6},
    {"_xyz_iterate",                                   (DL_FUNC) &_xyz_iterate,                                   14},
    {"_xyz_naive_interaction_search",                  (DL_FUNC) &_xyz_naive_interaction_search,                   4},
    ...
    {"_xyz_update_intr_vars",                          (DL_FUNC) &_xyz_update_intr_vars,                           3},
