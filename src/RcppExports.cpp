...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(scale_main(X, weights, standardize));
    return rcpp_result_gen;
END_RCPP
}
// scale_intr
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< NumericVector >::type weights(weightsSEXP);
    Rcpp::traits::input_parameter< bool >::type standardize(standardizeSEXP);
    rcpp_result_gen = Rcpp::wrap(absolute_covariates(X, Y, weights, standardize));
    return rcpp_result_gen;
END_RCPP
}
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< NumericVector >::type weights(weightsSEXP);
    Rcpp::traits::input_parameter< bool >::type standardize(standardizeSEXP);
    rcpp_result_gen = Rcpp::wrap(absolute_covariates_pairs(pairs, X, Y, weights, standardize));
    return rcpp_result_gen;
END_RCPP
}
// clean_pairs
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< bool >::type standardize(standardizeSEXP);
    rcpp_result_gen = Rcpp::wrap(find_strongest_pairs(pairs, X, Y, weights, max_number_of_pairs, standardize));
    return rcpp_result_gen;
END_RCPP
}
// equalpairs
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< int >::type max_number_of_pairs(max_number_of_pairsSEXP);
    Rcpp::traits::input_parameter< bool >::type standardize(standardizeSEXP);
    rcpp_result_gen = Rcpp::wrap(naive_interaction_search(X, Y, weights, max_number_of_pairs, standardize));
    return rcpp_result_gen;
END_RCPP
}
// interaction_search
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< bool >::type standardize(standardizeSEXP);
    rcpp_result_gen = Rcpp::wrap(interaction_search(X, Y, weights, number_of_runs, max_number_of_pairs, negative, binary, standardize));
    return rcpp_result_gen;
END_RCPP
}
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< int >::type max_number_of_pairs(max_number_of_pairsSEXP);
    Rcpp::traits::input_parameter< bool >::type standardize(standardizeSEXP);
    rcpp_result_gen = Rcpp::wrap(interaction_search_low_level(X_binary, X, Y, weights, number_of_runs, max_number_of_pairs, standardize));
    return rcpp_result_gen;
END_RCPP
}
// soft_threshold
...
RcppExport SEXP _xyz2_create_lambda_sequence(SEXP max_covSEXP, SEXP alphaSEXP, SEXP n_lambdaSEXP, SEXP factor_eps_invSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(create_lambda_sequence(max_cov, alpha, n_lambda, factor_eps_inv));
    return rcpp_result_gen;
END_RCPP
}
// scan_main_effects
...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(scan_main_effects(X, Y, weights, main_effects, beta_main, lambdas, alpha, standardize, r, add_max, strong));
    return rcpp_result_gen;
END_RCPP
}
// scan_intr_effects
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< bool >::type standardize(standardizeSEXP);
    Rcpp::traits::input_parameter< bool >::type strong(strongSEXP);
    rcpp_result_gen = Rcpp::wrap(scan_intr_effects(X, residuals, X_bin, weights, intr_effects, beta_intr, intr_vars, lambdas, alpha, r, projections, standardize, strong));
    return rcpp_result_gen;
END_RCPP
}
// update_intr_final
...
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const NumericMatrix& >::type main_vars(main_varsSEXP);
    ...
    Rcpp::traits::input_parameter< int >::type r(rSEXP);
    Rcpp::traits::input_parameter< bool >::type standardize(standardizeSEXP);
    rcpp_result_gen = Rcpp::wrap(calculate_xbeta(main_vars, intr_vars, Y, weights, intercept, main_effects, beta_main, intr_effects, beta_intr, r, standardize));
    return rcpp_result_gen;
END_RCPP
}
// calculate_residuals
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< int >::type r(rSEXP);
    Rcpp::traits::input_parameter< bool >::type standardize(standardizeSEXP);
    rcpp_result_gen = Rcpp::wrap(calculate_residuals(main_vars, intr_vars, Y, weights, intercept, main_effects, beta_main, intr_effects, beta_intr, r, standardize));
    return rcpp_result_gen;
END_RCPP
}
// iterate
...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(iterate(main_vars, intr_vars, Y, residuals, intercept, main_effects, beta_main, intr_effects, beta_intr, weights, lambdas, alpha, standardize, r, maxiter_inner));
    return rcpp_result_gen;
END_RCPP
}
// update_intr_vars
